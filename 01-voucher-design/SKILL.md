...
| Level | Channels | Voucher scope |
|-------|----------|---------------|
| **S** | In-app + owned | 1–2 types, simple trigger |
| **M** | Adds 1–2 paid channels | 3–5 types, can A/B test |
| **L** | Full channels, agency | Multiple sets, custom creative concept |
